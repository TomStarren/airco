...
static const std::string &CUSTOM_SPECIAL_MODE_ECONOMIE = "Economie";
...
enum class CustomSpecialModes { OFF, HI_POWER, ECONOMIE, SILENT };
...
enum class SPECIAL { OFF = 0, HI_POWER = 1, ECONOMIE = 3, SILENT = 2 };
