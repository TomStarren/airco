...
static const std::string CUSTOM_SPECIAL_MODE_ENERGY_SAVER = "Energy Saver";
...
enum class CustomSpecialModes { OFF, HI_POWER, ENERGY_SAVER, SILENT };
...
enum class SPECIAL { OFF = 0, HI_POWER = 1, ENERGY_SAVER = 3, SILENT = 2 };
